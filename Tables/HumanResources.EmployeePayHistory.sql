CREATE TABLE [HumanResources].[EmployeePayHistory] (
  [BusinessEntityID2] [int] NOT NULL,
  [RateChangeDate] [datetime] NOT NULL,
  [Rate] [money] NOT NULL,
  [PayFrequency] [tinyint] NOT NULL,
  [ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF_EmployeePayHistory_ModifiedDate] DEFAULT (getdate()),
  CONSTRAINT [PK_EmployeePayHistory_BusinessEntityID_RateChangeDate] PRIMARY KEY CLUSTERED ([BusinessEntityID2], [RateChangeDate]),
...
ALTER TABLE [HumanResources].[EmployeePayHistory]
  ADD CONSTRAINT [FK_EmployeePayHistory_Employee_BusinessEntityID] FOREIGN KEY ([BusinessEntityID2]) REFERENCES [HumanResources].[Employee] ([BusinessEntityID])
GO
...
EXEC sys.sp_addextendedproperty N'VirtualFolder', N'HumanResources', 'SCHEMA', N'HumanResources', 'TABLE', N'EmployeePayHistory'
GO

EXEC sys.sp_addextendedproperty N'MS_Description', N'Employee identification number. Foreign key to Employee.BusinessEntityID.', 'SCHEMA', N'HumanResources', 'TABLE', N'EmployeePayHistory', 'COLUMN', N'BusinessEntityID2'
GO
