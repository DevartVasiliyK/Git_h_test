...
----------------------------------------------------------------
CREATE   PROCEDURE [dbo].[uspAddOrderTrackingEvent_copy]
   @SalesOrderID2 INT,
   @TrackingEventID INT,
   ...
   BEGIN TRY
      ...
      SET @TrackingNumber = (
         SELECT TOP 1 ot.CarrierTrackingNumber 
          ...
          WHERE ot.SalesOrderID = @SalesOrderID2);
      ...
      VALUES
         (@SalesOrderID2, @TrackingNumber, @TrackingEventID, @EventDetails, GETDATE());
